    ...
    <Flex justify="center" w="100%" gap={20} py={30} px={20} wrap="wrap">
        <Card maw={400} shadow="lg">
            ...
            <Text size="sm" c="dimmed">
                Share your thoughts about the professors you have had lectures,
                tutorials or labs with and help them become even better at what
                they do.
            </Text>
        ...
        <Card maw={400} shadow="lg">
            ...
            <Text size="sm" c="dimmed">
                Add new students, subjects and lecturers to the system. Edit or
                correct their data, check surveys and results.
            </Text>
